...
const styles = StyleSheet.create({
  ...
  heroPillText: { color: colors.ink, fontSize: 12, fontWeight: '900' },
  heroTitle: { color: '#ffffff', fontSize: 31, lineHeight: 38, fontWeight: '900' },
  heroMeta: { color: '#f6d979', fontSize: 13, lineHeight: 18, fontWeight: '900' },
  ...
  statValue: { color: colors.ink, fontSize: 22, lineHeight: 28, fontWeight: '900' },
  statLabel: { color: colors.muted, fontSize: 12, fontWeight: '900' },
  noticeText: { color: colors.tealDark, fontSize: 13, lineHeight: 19, fontWeight: '900' },
  errorText: { color: '#a13c33', fontSize: 13, lineHeight: 19, fontWeight: '900' },
  tabBar: {
    minHeight: 58,
    borderRadius: 22,
    padding: 6,
  ...
  tabText: { color: colors.tealDark, fontSize: 12, fontWeight: '900' },
  tabTextActive: { color: '#ffffff' },
  twoColumn: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'flex-start', gap: 12 },
  panel: {
    flex: 1,
    minWidth: 290,
    borderRadius: 26,
  ...
  panelTitle: { flex: 1, color: colors.ink, fontSize: 19, lineHeight: 25, fontWeight: '900' },
  ...
  messageList: { minHeight: 260, gap: 10 },
  messageBubble: { maxWidth: '88%', alignSelf: 'flex-start', borderRadius: 20, paddingHorizontal: 13, paddingVertical: 10, gap: 5, backgroundColor: colors.softTeal },
  messageBubbleMine: { alignSelf: 'flex-end', backgroundColor: colors.tealDark },
  messageBody: { color: colors.ink, fontSize: 14, lineHeight: 20, fontWeight: '800' },
  messageBodyMine: { color: '#ffffff' },
  messageTime: { color: colors.muted, fontSize: 10, fontWeight: '900' },
  ...
  composerInput: { flex: 1, minHeight: 38, maxHeight: 110, color: colors.ink, fontSize: 14, lineHeight: 20, fontWeight: '800' },
  ...
  textarea: { minHeight: 142, paddingTop: 12, textAlignVertical: 'top' },
  primaryButton: {
    minHeight: 46,
    borderRadius: 16,
    paddingHorizontal: 14,
  ...
  aiTitle: { flex: 1, color: colors.ink, fontSize: 20, lineHeight: 27, fontWeight: '900' },
  aiBadge: { overflow: 'hidden', borderRadius: 13, paddingHorizontal: 9, paddingVertical: 5, color: '#ffffff', backgroundColor: colors.tealDark, fontSize: 10, fontWeight: '900' },
  aiSummary: { color: '#33413b', fontSize: 15, lineHeight: 23, fontWeight: '800' },
  aiBlock: { gap: 8 },
  aiBlockTitle: { color: colors.ink, fontSize: 15, lineHeight: 20, fontWeight: '900' },
  aiPoint: { borderRadius: 17, padding: 11, flexDirection: 'row', gap: 9, backgroundColor: colors.softTeal },
  aiPointNumber: { width: 24, height: 24, borderRadius: 12, overflow: 'hidden', textAlign: 'center', color: '#ffffff', backgroundColor: colors.tealDark, fontSize: 12, lineHeight: 24, fontWeight: '900' },
  aiPointText: { flex: 1, color: colors.ink, fontSize: 13, lineHeight: 19, fontWeight: '800' },
  quizCard: { borderRadius: 17, padding: 11, gap: 5, backgroundColor: colors.softGold },
  quizPrompt: { color: colors.ink, fontSize: 13, lineHeight: 19, fontWeight: '900' },
  quizMeta: { color: colors.muted, fontSize: 12, lineHeight: 17, fontWeight: '800' },
  quizAnswer: { color: colors.tealDark, fontSize: 12, lineHeight: 17, fontWeight: '900' },
  ...
  flashFront: { color: colors.ink, fontSize: 13, lineHeight: 18, fontWeight: '900' },
  flashBack: { color: colors.muted, fontSize: 12, lineHeight: 18, fontWeight: '800' },
  voiceStatus: { minHeight: 58, borderRadius: 19, padding: 12, flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: colors.softBlue },
  voiceIcon: { width: 38, height: 38, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.blue },
  flexText: { flex: 1, minWidth: 0 },
  voiceTitle: { color: colors.ink, fontSize: 14, lineHeight: 19, fontWeight: '900' },
  voiceMeta: { color: colors.muted, fontSize: 12, lineHeight: 17, fontWeight: '800' },
  liveBox: { borderRadius: 26, padding: 18, gap: 12, alignItems: 'center', backgroundColor: '#101916' },
  liveIcon: { width: 70, height: 70, borderRadius: 28, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.coral, borderWidth: 4, borderColor: '#ffffff' },
  liveTitle: { color: '#ffffff', fontSize: 22, lineHeight: 28, fontWeight: '900', textAlign: 'center' },
  liveMeta: { color: '#dce7e1', fontSize: 13, lineHeight: 19, fontWeight: '800' },
  memberGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  memberCard: { minWidth: 220, flex: 1, minHeight: 70, borderRadius: 22, padding: 12, flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: colors.softTeal, borderWidth: 1, borderColor: '#d4e8df' },
  memberIcon: { width: 42, height: 42, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.tealDark },
  memberName: { color: colors.ink, fontSize: 15, lineHeight: 20, fontWeight: '900' },
  memberMeta: { color: colors.muted, fontSize: 12, lineHeight: 17, fontWeight: '800' },
  resourceCard: { borderRadius: 20, padding: 13, gap: 9, backgroundColor: colors.softGold },
  ...
  resourceTitle: { color: colors.ink, fontSize: 15, lineHeight: 20, fontWeight: '900' },
  resourceMeta: { color: colors.muted, fontSize: 11, lineHeight: 16, fontWeight: '900' },
  resourceBody: { color: '#4a4638', fontSize: 13, lineHeight: 19, fontWeight: '800' },
  ...
  smallButtonText: { color: colors.tealDark, fontSize: 11, fontWeight: '900' },
  emptyPanel: { minHeight: 150, borderRadius: 24, padding: 16, alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#f8fbf8', borderWidth: 1, borderColor: colors.line },
  emptyTitle: { color: colors.ink, fontSize: 20, lineHeight: 26, fontWeight: '900', textAlign: 'center' },
  emptyMeta: { color: colors.muted, fontSize: 13, lineHeight: 19, fontWeight: '800', textAlign: 'center' },
  modalBackdrop: { flex: 1, justifyContent: 'center', padding: 16, backgroundColor: 'rgba(7, 12, 10, 0.6)' },
  modalSheet: { width: '100%', maxWidth: 860, maxHeight: '88%', alignSelf: 'center', borderRadius: 28, padding: 16, gap: 14, backgroundColor: colors.paper, borderWidth: 1, borderColor: colors.line },
  modalHeader: { minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: 12 },
  modalIcon: { width: 44, height: 44, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.tealDark },
  modalTitle: { color: colors.ink, fontSize: 22, lineHeight: 28, fontWeight: '900' },
  modalMeta: { color: colors.muted, fontSize: 12, lineHeight: 18, fontWeight: '800' },
  closeButton: { width: 38, height: 38, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.softTeal },
  modalScroll: { gap: 14, paddingBottom: 6 },
});
